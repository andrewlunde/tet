...
describe('User', () => {
  ...
  it('registration can send email', async (done) => {
    ...
    const emailMsg = {
      ...
      html:
        'Please enter the following captcha <br /><img alt="captcha" src="https://b2.tet.io/file/tet/captchas/0.png" /> <br />on <a href="https://tet.io/verify-email">https://tet.io/verify-email</a>',
      subject: 'Please verify your email',
      text:
        'Please enter the following captcha https://b2.tet.io/file/tet/captchas/0.png on https://tet.io/verify-email',
