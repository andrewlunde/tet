...
describe('User', () => {
  ...
  it('registration can send email', async (done) => {
    ...
    const emailMsg = {
      from: { email: 'test@test.com', name: 'TET' },
      html:
        'Please enter the following captcha <br /><img alt="captcha" src="https://b2.tet.io/file/tet/captchas/0.png" /> <br />on <a href="https://tet.io/reset-password?key=test">https://tet.io/reset-password?key=test</a>',
      subject: 'Password reset',
      text:
        'Please enter the following captcha https://b2.tet.io/file/tet/captchas/0.png on https://tet.io/reset-password?key=test',
